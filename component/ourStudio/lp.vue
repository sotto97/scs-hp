		...
		<div class="mx-auto max-w-screen-2xl px-4 md:px-8">
			<header class="mb-8 flex items-center justify-between py-4 md:mb-12 md:py-8 xl:mb-16">
				...
				<a href="/" class="inline-flex items-center gap-2.5 text-2xl font-bold md:text-3xl" aria-label="logo">
					<svg width="95" height="94" viewBox="0 0 95 94" class="h-auto w-6 text-teal-500" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			...
			<section class="mt-2 sm:mt-20 flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
				...
				<div class="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-24">
					<p class="mb-4 font-semibold text-teal-500 md:mb-6 md:text-lg xl:text-xl">Sotto Creative Studio</p>
					...
					<div class="gap-2.5 flex sm:flex-row sm:justify-center lg:justify-start w-full">
						<div class="w-1/2 md:w-auto">
							<a
								href="#"
								class="rounded-lg bg-teal-500 block md:inline px-8 py-4 text-center text-sm font-semibold outline-none transition duration-100 hover:bg-teal-600 active:bg-teal-700 md:text-base"
							>
								<span class="text-white">Join Us</span>
							</a>
						</div>
						<div class="w-1/2 md:w-auto">
							<a href="#" class="rounded-lg bg-gray-200 block md:inline px-8 py-4 text-center text-sm font-semibold transition duration-100 hover:bg-gray-300 active:text-gray-700 md:text-base">
				...
				<div class="mt-4 flex items-center justify-center gap-4 sm:mt-16 lg:justify-start">
					...
					<div class="flex gap-4">
						<a href="https://www.instagram.com/xiacun_youjie/" target="_blank" class="text-gray-400 transition duration-100 hover:text-teal-500 active:text-teal-600">
						...
						<a href="https://github.com/sotto97" target="_blank" class="text-gray-400 transition duration-100 hover:text-teal-500 active:text-teal-600">
							<svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								<path
						...
						<a href="#" target="_blank" class="text-gray-400 transition duration-100 hover:text-teal-500 active:text-teal-600">
							<svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								<!-- <path
									d="M12 44.898438 14.5 C 44.5 12.300781 42.601563 10.699219 40.398438 10.199219 C 37.101563 9.5 31 9 24.398438 9 C 17.800781 9 11.601563 9.5 8.300781 10.199219 C 6.101563 10.699219 4.199219 12.199219 3.800781 14.5 C 3.398438 17 3 20.5 3 25 C 3 29.5 3.398438 33 3.898438 35.5 C 4.300781 37.699219 6.199219 39.300781 8.398438 39.800781 C 11.898438 40.5 17.898438 41 24.5 41 C 31.101563 41 37.101563 40.5 40.601563 39.800781 C 42.800781 39.300781 44.699219 37.800781 45.101563 35.5 C 45.5 33 46 29.398438 46.101563 25 C 45.898438 20.5 45.398438 17 44.898438 14.5 Z M 19 32 L 19 18 L 31.199219 25 Z"
								/> -->
							</svg>
						</a>
					</div>
