			...
			<section class="mt-2 sm:mt-20 flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
				...
				<div class="mt-4 flex items-center justify-center gap-4 sm:mt-16 lg:justify-start xl:w-4/12">
					...
					<div class="flex gap-4">
						<a href="https://www.instagram.com/xiacun_youjie/" target="_blank" class="text-gray-400 transition duration-100 hover:text-emerald-500 active:text-emerald-600">
						...
						<a href="https://github.com/sotto97" target="_blank" class="text-gray-400 transition duration-100 hover:text-emerald-500 active:text-emerald-600">
							<svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								<path
						...
						<a href="#" target="_blank" class="text-gray-400 transition duration-100 hover:text-emerald-500 active:text-emerald-600">
							<svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"></svg>
						</a>
					</div>
				</div>
				<!-- social - end -->
