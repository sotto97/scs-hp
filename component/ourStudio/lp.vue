			...
			<section class="mt-2 sm:mt-20 flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
				...
				<div class="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-24">
					...
					<div class="gap-2.5 flex sm:flex-row sm:justify-center lg:justify-start w-full">
						<div class="w-1/2 md:w-auto">
							<a
								href="#"
								class="rounded-lg bg-indigo-500 block md:inline px-8 py-4 text-center text-sm font-semibold outline-none transition duration-100 hover:bg-indigo-600 active:bg-indigo-700 md:text-base"
							>
				...
				<div class="mt-4 flex items-center justify-center gap-4 sm:mt-16 lg:justify-start">
					...
					<div class="flex gap-4">
						<a href="https://www.instagram.com/xiacun_youjie/" target="_blank" class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600">
						...
						<a href="https://github.com/sotto97" target="_blank" class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600">
							<svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								<path
						...
						<a href="#" target="_blank" class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600">
							<svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
								<!-- <path
